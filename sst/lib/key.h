...
private:
    ...
    static void gotChkR1(Host *h, KeyChunkChkR1Data &r1, const SocketEndpoint &ep);
...
public:
    ...
    void receive(QByteArray &msg, XdrStream &rs, const SocketEndpoint &src);
...
/**
 * Mixin class for SST::Host state.
 */
class KeyHostState
{
    friend class KeyInitiator;
