...
public:
    ...
    virtual Qt::ItemFlags flags(int /* column */, Qt::ItemFlags flags) const { return flags; }
    ...
    ChatItemModel* model() const { return _model; }

    void setModel(ChatItemModel* model) { _model = model; }
